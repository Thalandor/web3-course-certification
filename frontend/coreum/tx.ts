...
export namespace AssetNFT {
  export const MsgIssueClass = function <
    I extends Exact<DeepPartial<AssetNFTMsgIssueClass>, I>
  >(object: I) {
    return {
  ...
  export const MsgMint = function <
    I extends Exact<DeepPartial<AssetNFTMsgMint>, I>
  >(object: I) {
    return {
  ...
  export const AddToWhitelist = function <
    I extends Exact<DeepPartial<MsgAddToWhitelist>, I>
  >(object: I) {
    return {
      typeUrl: '/coreum.asset.nft.v1.MsgAddToWhitelist',
      value: MsgAddToWhitelist.fromPartial(object),
    }
  }
}
